...
//            wind1T,wind2T,wind3T,climate1T,climate2T,climate3T;
    ...
    public void onClick(View v) {
        if(v.getId()==R.id.title_city_update){
            getWeatherDatafromNet("101270101");
        }
...
//        wind3T.setText(todayWeather.getFengli3());
        ...
        if(todayWeather.getPm25()!=null) {
            ...
            if (pm25 <= 50) {
                PM25Img.setImageResource(R.drawable.pm25_5);
            } else if (pm25 >= 51 && pm25 <= 100) {
                PM25Img.setImageResource(R.drawable.pm25_2);
            } else if (pm25 >= 101 && pm25 <= 150) {
                PM25Img.setImageResource(R.drawable.pm25_3);
            } else if (pm25 >= 151 && pm25 <= 200) {
                PM25Img.setImageResource(R.drawable.pm25_4);
            } else if (pm25 >= 201 && pm25 <= 300) {
                PM25Img.setImageResource(R.drawable.pm25_1);
            }
        }
        if(todayWeather.getType()!=null) {
            ...
            switch (todayWeather.getType()) {
                ...
                case "雷阵雨":
                    ...
                    break;
                case "雷阵雨加暴":
                    weatherImg.setImageResource(R.drawable.weather_leizhenyujiabaoyu);
                    break;
                case "暴雨":
